...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_15 -L processing_system7_vip_v1_0_17 -L fifo_generator_v13_2_9 -L axi_clock_converter_v2_1_28 -L generic_baseblocks_v2_1_1 -L axi_data_fifo_v2_1_28 -L axi_register_slice_v2_1_29 -L axi_protocol_converter_v2_1_29 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot VNAMI_BLOCK_DESIGN xil_defaultlib.VNAMI_BLOCK_DESIGN xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim VNAMI_BLOCK_DESIGN -key {Behavioral:sim_1:Functional:VNAMI_BLOCK_DESIGN} -tclbatch cmd.tcl -protoinst "protoinst_files/VNAMI_BLOCK_DESIGN.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb VNAMI_BLOCK_DESIGN.wdb xsim.dir libdpi.so)
