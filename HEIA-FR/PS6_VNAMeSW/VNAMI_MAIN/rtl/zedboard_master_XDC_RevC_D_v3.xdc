...
# JA Pmod - Bank 13
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN P22 [get_ports IQ_rdy_PL_o]
# set_property PACKAGE_PIN Y11  [get_ports {IQ_rdy_PL_o}];  # "JA1"
#     set_property IOSTANDARD LVCMOS33 [get_ports {IQ_rdy_PL_o}];

set_property PACKAGE_PIN M21 [get_ports write_IQ_o]
# set_property PACKAGE_PIN AA11 [get_ports {write_IQ_o}];  # "JA2"
#    set_property IOSTANDARD LVCMOS33 [get_ports {write_IQ_o}];

#set_property PACKAGE_PIN Y19  [get_ports {SER_RX_o}];  # "JA3"
#set_property IOSTANDARD LVCMOS33 [get_ports {SER_RX_o}];
#set_property PACKAGE_PIN AA9  [get_ports {RCLR_o}];  # "JA4"
#    set_property IOSTANDARD LVCMOS33 [get_ports {RCLR_o}];
...
# JB Pmod - Bank 13
# ----------------------------------------------------------------------------
#set_property PACKAGE_PIN W12 [get_ports {SER_o}];  # "JB1"
#   set_property IOSTANDARD LVCMOS33 [get_ports {SER_o}];
#set_property PACKAGE_PIN W11 [get_ports {SRCLK_o}];  # "JB2"
#    set_property IOSTANDARD LVCMOS33 [get_ports {SRCLK_o}];
#set_property PACKAGE_PIN V10 [get_ports {SRCLR_o}];  # "JB3"
#    set_property IOSTANDARD LVCMOS33 [get_ports {SRCLR_o}];
#set_property PACKAGE_PIN W8 [get_ports {RCLK_o}];  # "JB4"
...
#set_property PACKAGE_PIN AB7 [get_ports {SRCLK_o}];  # "JC1_P"
...
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN P16 [get_ports reset_i]
set_property PACKAGE_PIN R16 [get_ports btn_d_i]
set_property PACKAGE_PIN N15 [get_ports btn_l_i]
set_property PACKAGE_PIN R18 [get_ports btn_r_i]
set_property PACKAGE_PIN T18 [get_ports btn_u_i]
...
## ----------------------------------------------------------------------------
set_property PACKAGE_PIN F22 [get_ports {sw_i[0]}]
set_property PACKAGE_PIN G22 [get_ports {sw_i[1]}]
set_property PACKAGE_PIN H22 [get_ports {sw_i[2]}]
set_property PACKAGE_PIN F21 [get_ports {sw_i[3]}]
set_property PACKAGE_PIN H19 [get_ports {sw_i[4]}]
set_property PACKAGE_PIN H18 [get_ports {sw_i[5]}]
set_property PACKAGE_PIN H17 [get_ports {sw_i[6]}]
set_property PACKAGE_PIN M15 [get_ports {sw_i[7]}]
...
set_property PACKAGE_PIN M22 [get_ports {ADC_RX_i[11]}]
set_property PACKAGE_PIN T17 [get_ports {ADC_RX_i[7]}]
set_property PACKAGE_PIN T16 [get_ports {ADC_RX_i[9]}]
set_property PACKAGE_PIN J22 [get_ports {ADC_RX_i[8]}]
set_property PACKAGE_PIN J21 [get_ports {ADC_RX_i[10]}]
set_property PACKAGE_PIN N18 [get_ports {ADC_RX_i[3]}]
set_property PACKAGE_PIN N17 [get_ports {ADC_RX_i[4]}]
set_property PACKAGE_PIN P21 [get_ports {ADC_RX_i[5]}]
set_property PACKAGE_PIN P20 [get_ports {ADC_RX_i[6]}]
set_property PACKAGE_PIN J17 [get_ports {ADC_RX_i[13]}]
set_property PACKAGE_PIN J16 [get_ports {ADC_RX_i[0]}]
set_property PACKAGE_PIN K21 [get_ports {ADC_RX_i[1]}]
set_property PACKAGE_PIN J20 [get_ports {ADC_RX_i[2]}]
...
set_property PACKAGE_PIN G20 [get_ports {ADC_RX_i[12]}]
set_property PACKAGE_PIN E20 [get_ports {ADC_TX_i[12]}]
set_property PACKAGE_PIN E19 [get_ports {ADC_TX_i[13]}]
...
set_property PACKAGE_PIN A19 [get_ports {ADC_TX_i[8]}]
set_property PACKAGE_PIN A18 [get_ports {ADC_TX_i[10]}]
set_property PACKAGE_PIN C22 [get_ports {ADC_TX_i[9]}]
set_property PACKAGE_PIN D22 [get_ports {ADC_TX_i[11]}]
...
set_property PACKAGE_PIN A17 [get_ports {ADC_TX_i[4]}]
set_property PACKAGE_PIN A16 [get_ports {ADC_TX_i[6]}]
set_property PACKAGE_PIN C18 [get_ports {ADC_TX_i[5]}]
set_property PACKAGE_PIN C17 [get_ports {ADC_TX_i[7]}]
set_property PACKAGE_PIN B15 [get_ports {ADC_TX_i[0]}]
set_property PACKAGE_PIN C15 [get_ports {ADC_TX_i[2]}]
set_property PACKAGE_PIN B17 [get_ports {ADC_TX_i[1]}]
set_property PACKAGE_PIN B16 [get_ports {ADC_TX_i[3]}]
set_property PACKAGE_PIN B21 [get_ports FMC_LA33_P]

# set_property PACKAGE_PIN P22 [get_ports SWR_TX_SER]
set_property PACKAGE_PIN Y11 [get_ports SWR_TX_SER]
# set_property PACKAGE_PIN M21 [get_ports SWR_TX_SRCLK]
set_property PACKAGE_PIN AA11 [get_ports SWR_TX_SRCLK]
# set_property PACKAGE_PIN L22 [get_ports SWR_TX_SRCLR]
set_property PACKAGE_PIN W10 [get_ports SWR_TX_SRCLR]
# set_property PACKAGE_PIN J18 [get_ports SWR_TX_RCLK]
set_property PACKAGE_PIN Y10 [get_ports SWR_TX_RCLK]

set_property PACKAGE_PIN N19 [get_ports SWR_RX_SER]
set_property PACKAGE_PIN W12 [get_ports V_o[0]]
set_property PACKAGE_PIN P18 [get_ports SWR_RX_SRCLK]
set_property PACKAGE_PIN W11 [get_ports V_o[1]]
set_property PACKAGE_PIN N22 [get_ports SWR_RX_SRCLR]
set_property PACKAGE_PIN V10 [get_ports V_o[2]]
set_property PACKAGE_PIN L21 [get_ports SWR_RX_RCLK]
set_property PACKAGE_PIN W8 [get_ports V_o[3]]

# set_property PACKAGE_PIN Y11 [get_ports clk_80_o]
# set_property PACKAGE_PIN AA11 [get_ports clk_100_o]
...
# create_clock -period 12.500 -name clk_80 -waveform {0.000 6.250} -add [get_nets VNAMI_BLOCK_DESIGN_i/TL_VNA_MAIN_0/clk_80_o__0]
