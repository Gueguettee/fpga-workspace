...
HD_PWD='C:/git/fpga-workspace/ELEC_APPLI/ELEC_APPLI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SD_filter_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SD_filter_toplevel.tcl -notrace
