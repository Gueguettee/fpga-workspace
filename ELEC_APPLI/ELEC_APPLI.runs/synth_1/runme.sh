...
HD_PWD='C:/git/fpga-workspace/ELEC_APPLI/ELEC_APPLI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SD_filter_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SD_filter_toplevel.tcl
