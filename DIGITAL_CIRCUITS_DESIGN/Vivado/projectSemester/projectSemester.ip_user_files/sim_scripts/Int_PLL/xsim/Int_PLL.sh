...
#
# Script generated by Vivado on Fri Dec 15 16:20:05 +0100 2023
...
#
# Usage        : Int_PLL.sh
#                Int_PLL.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Int_PLL.sh [-reset_run]
#                Int_PLL.sh [-reset_log]
#                Int_PLL.sh [-help]
#
...
# script info
echo -e "Int_PLL.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Int_PLL.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Int_PLL xil_defaultlib.Int_PLL xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Int_PLL -key {Behavioral:sim_1:Functional:Int_PLL} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Int_PLL.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Int_PLL.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Int_PLL.sh [-help]\n\
Usage: Int_PLL.sh [-step]\n\
Usage: Int_PLL.sh [-lib_map_path]\n\
Usage: Int_PLL.sh [-reset_run]\n\
Usage: Int_PLL.sh [-reset_log]\n\
Usage: Int_PLL.sh [-keep_index]\n\
Usage: Int_PLL.sh [-noclean_files]\n\n\
