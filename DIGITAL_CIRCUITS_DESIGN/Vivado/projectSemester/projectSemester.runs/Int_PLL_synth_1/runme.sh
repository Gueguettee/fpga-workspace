...
HD_PWD='C:/git/digital-circuits-desighs-workspace/Vivado/projectSemester/projectSemester.runs/Int_PLL_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Int_PLL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Int_PLL.tcl
