...
HD_PWD='C:/git/digital-circuits-desighs-workspace/Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADD_TL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADD_TL.tcl
