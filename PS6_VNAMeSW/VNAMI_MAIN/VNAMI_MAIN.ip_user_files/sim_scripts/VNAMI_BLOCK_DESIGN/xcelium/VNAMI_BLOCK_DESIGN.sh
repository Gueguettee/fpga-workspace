...
#
# Script generated by Vivado on Sun May 12 20:54:53 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : VNAMI_BLOCK_DESIGN.sh
...
#
# Usage        : VNAMI_BLOCK_DESIGN.sh
#                VNAMI_BLOCK_DESIGN.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                VNAMI_BLOCK_DESIGN.sh [-reset_run]
#                VNAMI_BLOCK_DESIGN.sh [-reset_log]
#                VNAMI_BLOCK_DESIGN.sh [-help]
#
...
#                script (type 'VNAMI_BLOCK_DESIGN.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_14 -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_15 -libname processing_system7_vip_v1_0_17 -libname fifo_generator_v13_2_9 -libname axi_clock_converter_v2_1_28 -libname generic_baseblocks_v2_1_1 -libname axi_data_fifo_v2_1_28 -libname axi_register_slice_v2_1_29 -libname axi_protocol_converter_v2_1_29 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 axi_infrastructure_v1_1_0 axi_vip_v1_1_15 processing_system7_vip_v1_0_17 fifo_generator_v13_2_9 axi_clock_converter_v2_1_28 generic_baseblocks_v2_1_1 axi_data_fifo_v2_1_28 axi_register_slice_v2_1_29 axi_protocol_converter_v2_1_29)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "VNAMI_BLOCK_DESIGN.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./VNAMI_BLOCK_DESIGN.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_clock_converter_v2_1_28 $xmvlog_opts +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/ec67/hdl" +incdir+"../../../../VNAMI_MAIN.gen/sources_1/bd/VNAMI_BLOCK_DESIGN/ipshared/6b2b/hdl" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.VNAMI_BLOCK_DESIGN xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.VNAMI_BLOCK_DESIGN -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log VNAMI_BLOCK_DESIGN_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./VNAMI_BLOCK_DESIGN.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: VNAMI_BLOCK_DESIGN.sh [-help]\n\
Usage: VNAMI_BLOCK_DESIGN.sh [-step]\n\
Usage: VNAMI_BLOCK_DESIGN.sh [-lib_map_path]\n\
Usage: VNAMI_BLOCK_DESIGN.sh [-reset_run]\n\
Usage: VNAMI_BLOCK_DESIGN.sh [-reset_log]\n\
Usage: VNAMI_BLOCK_DESIGN.sh [-keep_index]\n\
Usage: VNAMI_BLOCK_DESIGN.sh [-noclean_files]\n\n\
