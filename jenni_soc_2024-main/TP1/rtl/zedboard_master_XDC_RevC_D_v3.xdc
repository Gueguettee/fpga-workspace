...
#set_property PACKAGE_PIN W11 [get_ports {serial_o}];  # "JB2"
#set_property PACKAGE_PIN V10 [get_ports {serial_i}];  # "JB3"
...
# User LEDs - Bank 33
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN T22 [get_ports {port1_o[0]}]
set_property PACKAGE_PIN T21 [get_ports {port1_o[1]}]
set_property PACKAGE_PIN U22 [get_ports {port1_o[2]}]
set_property PACKAGE_PIN U21 [get_ports {port1_o[3]}]
set_property PACKAGE_PIN V22 [get_ports {port1_o[4]}]
set_property PACKAGE_PIN W22 [get_ports {port1_o[5]}]
set_property PACKAGE_PIN U19 [get_ports {port1_o[6]}]
set_property PACKAGE_PIN U14 [get_ports {port1_o[7]}]
...
## ----------------------------------------------------------------------------
# set_property PACKAGE_PIN G17 [get_ports {OTG-RESETN}];  # "OTG-RESETN"

# ----------------------------------------------------------------------------
# User DIP Switches - Bank 35
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN F22 [get_ports {port1_i[0]}]
set_property PACKAGE_PIN G22 [get_ports {port1_i[1]}]
set_property PACKAGE_PIN H22 [get_ports {port1_i[2]}]
set_property PACKAGE_PIN F21 [get_ports {port1_i[3]}]
set_property PACKAGE_PIN H19 [get_ports {port1_i[4]}]
set_property PACKAGE_PIN H18 [get_ports {port1_i[5]}]
set_property PACKAGE_PIN H17 [get_ports {port1_i[6]}]
set_property PACKAGE_PIN M15 [get_ports {port1_i[7]}]
