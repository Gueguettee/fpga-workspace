...
end entity average_IQ;

architecture mix of average_IQ is
...
--------------------------- DESIGN ----------------------------
    ...
    result_o        <= result_s(BIT_WIDTH-1 downto 0);
                ...
                case state_s is
                    ...
                    when SAMPLING =>
                        if counter_s = counter_max_s then
                            ...
                            sum_s       <= std_logic_vector(signed(sum_s) + signed(IQ_input_i));
                        end if;
