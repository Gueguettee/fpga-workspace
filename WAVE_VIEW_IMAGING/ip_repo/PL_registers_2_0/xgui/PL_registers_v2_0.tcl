...
proc update_PARAM_VALUE.ADC_DATA_LENGTH { PARAM_VALUE.ADC_DATA_LENGTH } {
	# Procedure called to update ADC_DATA_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADC_DATA_LENGTH { PARAM_VALUE.ADC_DATA_LENGTH } {
	# Procedure called to validate ADC_DATA_LENGTH
	return true
}

proc update_PARAM_VALUE.ADC_DATA_RANGE_INDICATOR_LENGTH { PARAM_VALUE.ADC_DATA_RANGE_INDICATOR_LENGTH } {
	# Procedure called to update ADC_DATA_RANGE_INDICATOR_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADC_DATA_RANGE_INDICATOR_LENGTH { PARAM_VALUE.ADC_DATA_RANGE_INDICATOR_LENGTH } {
	# Procedure called to validate ADC_DATA_RANGE_INDICATOR_LENGTH
	return true
}

proc update_PARAM_VALUE.ADC_THRESHOLD_DATA_LENGTH { PARAM_VALUE.ADC_THRESHOLD_DATA_LENGTH } {
	# Procedure called to update ADC_THRESHOLD_DATA_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADC_THRESHOLD_DATA_LENGTH { PARAM_VALUE.ADC_THRESHOLD_DATA_LENGTH } {
	# Procedure called to validate ADC_THRESHOLD_DATA_LENGTH
	return true
}
...
proc update_PARAM_VALUE.LED_INDICATORS_DATA_LENGTH { PARAM_VALUE.LED_INDICATORS_DATA_LENGTH } {
	# Procedure called to update LED_INDICATORS_DATA_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.LED_INDICATORS_DATA_LENGTH { PARAM_VALUE.LED_INDICATORS_DATA_LENGTH } {
	# Procedure called to validate LED_INDICATORS_DATA_LENGTH
	return true
}
...
proc update_PARAM_VALUE.OFFSET_DATA_LENGTH { PARAM_VALUE.OFFSET_DATA_LENGTH } {
	# Procedure called to update OFFSET_DATA_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.OFFSET_DATA_LENGTH { PARAM_VALUE.OFFSET_DATA_LENGTH } {
	# Procedure called to validate OFFSET_DATA_LENGTH
	return true
}
...
proc update_PARAM_VALUE.SPI_CLOCK_SPEED_DATA_LENGTH { PARAM_VALUE.SPI_CLOCK_SPEED_DATA_LENGTH } {
	# Procedure called to update SPI_CLOCK_SPEED_DATA_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SPI_CLOCK_SPEED_DATA_LENGTH { PARAM_VALUE.SPI_CLOCK_SPEED_DATA_LENGTH } {
	# Procedure called to validate SPI_CLOCK_SPEED_DATA_LENGTH
	return true
}
...
proc update_PARAM_VALUE.SYNTH_STABILITY_DELAY_DATA_LENGTH { PARAM_VALUE.SYNTH_STABILITY_DELAY_DATA_LENGTH } {
	# Procedure called to update SYNTH_STABILITY_DELAY_DATA_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SYNTH_STABILITY_DELAY_DATA_LENGTH { PARAM_VALUE.SYNTH_STABILITY_DELAY_DATA_LENGTH } {
	# Procedure called to validate SYNTH_STABILITY_DELAY_DATA_LENGTH
	return true
}
...
proc update_PARAM_VALUE.VGA_POWER_ADJUST_ENABLE_DATA_LENGTH { PARAM_VALUE.VGA_POWER_ADJUST_ENABLE_DATA_LENGTH } {
	# Procedure called to update VGA_POWER_ADJUST_ENABLE_DATA_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.VGA_POWER_ADJUST_ENABLE_DATA_LENGTH { PARAM_VALUE.VGA_POWER_ADJUST_ENABLE_DATA_LENGTH } {
	# Procedure called to validate VGA_POWER_ADJUST_ENABLE_DATA_LENGTH
	return true
}
...
proc update_MODELPARAM_VALUE.ADC_DATA_LENGTH { MODELPARAM_VALUE.ADC_DATA_LENGTH PARAM_VALUE.ADC_DATA_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADC_DATA_LENGTH}] ${MODELPARAM_VALUE.ADC_DATA_LENGTH}
}

proc update_MODELPARAM_VALUE.SYNTH_STABILITY_DELAY_DATA_LENGTH { MODELPARAM_VALUE.SYNTH_STABILITY_DELAY_DATA_LENGTH PARAM_VALUE.SYNTH_STABILITY_DELAY_DATA_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SYNTH_STABILITY_DELAY_DATA_LENGTH}] ${MODELPARAM_VALUE.SYNTH_STABILITY_DELAY_DATA_LENGTH}
}

proc update_MODELPARAM_VALUE.ADC_DATA_RANGE_INDICATOR_LENGTH { MODELPARAM_VALUE.ADC_DATA_RANGE_INDICATOR_LENGTH PARAM_VALUE.ADC_DATA_RANGE_INDICATOR_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADC_DATA_RANGE_INDICATOR_LENGTH}] ${MODELPARAM_VALUE.ADC_DATA_RANGE_INDICATOR_LENGTH}
}

proc update_MODELPARAM_VALUE.ADC_THRESHOLD_DATA_LENGTH { MODELPARAM_VALUE.ADC_THRESHOLD_DATA_LENGTH PARAM_VALUE.ADC_THRESHOLD_DATA_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADC_THRESHOLD_DATA_LENGTH}] ${MODELPARAM_VALUE.ADC_THRESHOLD_DATA_LENGTH}
}

proc update_MODELPARAM_VALUE.LED_INDICATORS_DATA_LENGTH { MODELPARAM_VALUE.LED_INDICATORS_DATA_LENGTH PARAM_VALUE.LED_INDICATORS_DATA_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.LED_INDICATORS_DATA_LENGTH}] ${MODELPARAM_VALUE.LED_INDICATORS_DATA_LENGTH}
}

proc update_MODELPARAM_VALUE.SPI_CLOCK_SPEED_DATA_LENGTH { MODELPARAM_VALUE.SPI_CLOCK_SPEED_DATA_LENGTH PARAM_VALUE.SPI_CLOCK_SPEED_DATA_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SPI_CLOCK_SPEED_DATA_LENGTH}] ${MODELPARAM_VALUE.SPI_CLOCK_SPEED_DATA_LENGTH}
}

proc update_MODELPARAM_VALUE.OFFSET_DATA_LENGTH { MODELPARAM_VALUE.OFFSET_DATA_LENGTH PARAM_VALUE.OFFSET_DATA_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.OFFSET_DATA_LENGTH}] ${MODELPARAM_VALUE.OFFSET_DATA_LENGTH}
}

proc update_MODELPARAM_VALUE.VGA_POWER_ADJUST_ENABLE_DATA_LENGTH { MODELPARAM_VALUE.VGA_POWER_ADJUST_ENABLE_DATA_LENGTH PARAM_VALUE.VGA_POWER_ADJUST_ENABLE_DATA_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.VGA_POWER_ADJUST_ENABLE_DATA_LENGTH}] ${MODELPARAM_VALUE.VGA_POWER_ADJUST_ENABLE_DATA_LENGTH}
}
