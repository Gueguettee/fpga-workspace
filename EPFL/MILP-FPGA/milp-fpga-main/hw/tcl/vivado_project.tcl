...
#
# vivado_project.tcl: Tcl script for re-creating project 'DenseSolve_Vivado'
#
# Generated by Vivado on Fri May 23 14:20:57 CEST 2025
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/build/ip_repo"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "DenseSolve_Vivado"
...
# clk_wiz output frequency (MHz) — overridden per-kernel via -tclargs --clk_freq.
set CLK_FREQ_MHZ 200

# ILA toggle. Default OFF (saves ~10-15 BRAMs and ~3-5k LUTs on the master1 ILA).
# Enable by passing -tclargs --ila to add system_ila taps on the AXI-Lite control
# bus and on the master1 AXI bundle for on-board waveform debug via Vivado HW.
set USE_ILA 0
...
if { $::argc > 0 } {
  for {set i 0} {$i < $::argc} {incr i} {
    ...
    switch -regexp -- $option {
      ...
      "--clk_freq"     { incr i; set CLK_FREQ_MHZ [lindex $::argv $i] }
      "--ila"          { set USE_ILA 1 }
      "--help"         { print_help }
      default {
        if { [regexp {^-} $option] } {
...
# Derive the kernel IP name from the project name (strip _Vivado suffix)
# e.g. "DenseSolve_Vivado" -> "DenseSolve"
set _kernel_ip_name_ [regsub {_Vivado$} $_xil_proj_name_ ""]
...
# Create project or reuse existing one
set xpr_file "./build/${_xil_proj_name_}/${_xil_proj_name_}.xpr"
if { [file exists $xpr_file] } {
  puts "INFO: Project ${_xil_proj_name_} already exists, opening it."
  open_project $xpr_file

  # Refresh IP catalog so the block design picks up any newly exported HLS IP
  update_ip_catalog
  upgrade_ip [get_ips]
  report_ip_status
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/build/ip_repo"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  "
  if {$USE_ILA} {
    append list_check_ips " xilinx.com:ip:system_ila:1.1"
  }
  ...
  # Create instance: ${_kernel_ip_name_}_0, and set properties
  set ${_kernel_ip_name_}_0 [ create_bd_cell -type ip -vlnv EPFL:hls:${_kernel_ip_name_}:1.0 ${_kernel_ip_name_}_0 ]

  # axi_smc → HP0 (master1). Both kernels use a single master AXI bundle.
  ...
  if {$USE_ILA} {
    # Create instance: system_ila_0 — taps the AXI-Lite control bus.
    set system_ila_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 system_ila_0 ]
    set_property CONFIG.C_TRIGOUT_EN {true} $system_ila_0

    # Create instance: system_ila_1 — taps master1 (input/output AXI bundle).
...
\
  ...
  connect_bd_intf_net -intf_net ${_kernel_ip_name_}_0_m_axi_master1 [get_bd_intf_pins ${_kernel_ip_name_}_0/m_axi_master1] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ${_kernel_ip_name_}_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  if {$USE_ILA} {
    connect_bd_intf_net -intf_net [get_bd_intf_nets ${_kernel_ip_name_}_0_m_axi_master1] [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins system_ila_1/SLOT_0_AXI]
  ...
  set _rst_pins [list \
    [get_bd_pins ${_kernel_ip_name_}_0/ap_rst_n] \
    ...
    [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] \
  ]
  set _clk_pins [list \
    [get_bd_pins ${_kernel_ip_name_}_0/ap_clk] \
  ...
  if {$USE_ILA} {
    lappend _rst_pins [get_bd_pins system_ila_0/resetn]
    lappend _rst_pins [get_bd_pins system_ila_1/resetn]
    lappend _clk_pins [get_bd_pins system_ila_0/clk]
    lappend _clk_pins [get_bd_pins system_ila_1/clk]
  }
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn {*}$_rst_pins
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 {*}$_clk_pins
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces ${_kernel_ip_name_}_0/Data_m_axi_master1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces ${_kernel_ip_name_}_0/Data_m_axi_master1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ${_kernel_ip_name_}_0/s_axi_control/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces ${_kernel_ip_name_}_0/Data_m_axi_master1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-441,-599",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 3 -x 1010 -y 90 -defaultsOSRD
preplace inst ${_kernel_ip_name_}_0 -pg 1 -lvl 5 -x 1840 -y 280 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1490 -y 130 -defaultsOSRD
preplace inst rst_ps8_0_100M -pg 1 -lvl 1 -x 210 -y 300 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 550 -y 270 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 6 30 200 390 350 700 180 1330 250 1660 200 N
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 4 20 190 NJ 190 NJ 190 1320
preplace netloc rst_ps8_0_100M_peripheral_aresetn 1 1 5 400 370 NJ 370 1340 260 1640 370 2030
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 3 1 N 70
preplace netloc ps8_0_axi_periph_M00_AXI 1 4 1 1650 100n
preplace netloc ${_kernel_ip_name_}_0_m_axi_master1 1 1 5 410 360 NJ 360 NJ 360 NJ 360 2020
preplace netloc axi_smc_M00_AXI 1 2 1 690 60n
levelinfo -pg 1 0 210 550 1010 1490 1840 2130 2240
pagesize -pg 1 -db -bbox -sgen 0 0 2240 400
"
}
...
# LIBRARY is read-only in Vivado 2025.2+
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/build/${_xil_proj_name_}/${_xil_proj_name_}.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
