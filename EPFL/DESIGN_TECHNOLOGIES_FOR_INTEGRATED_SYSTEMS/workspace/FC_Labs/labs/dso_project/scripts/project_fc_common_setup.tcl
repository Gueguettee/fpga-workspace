...
set DESIGN_NAME		"mac_unit"		; # set design name
...
# Need to be local to each run DSO.ai will do.
# Putting all the "output" files in a single directory to use as "design_data" in DSO.ai
