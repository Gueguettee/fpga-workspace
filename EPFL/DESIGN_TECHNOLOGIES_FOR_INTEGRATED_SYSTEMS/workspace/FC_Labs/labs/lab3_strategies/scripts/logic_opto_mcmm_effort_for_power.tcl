...
# Copy and open block
copy_block -from ${DESIGN_NAME}/rtl_read -to ${DESIGN_NAME}/mcmm_and_logic_opto_power_effort
open_block ${DESIGN_NAME}/mcmm_and_logic_opto_power_effort
...
# Collect the reports
set report_prefix "logic_opto_power"
