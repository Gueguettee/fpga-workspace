...
# Copy and open block
copy_block -from ${DESIGN_NAME}/rtl_read -to ${DESIGN_NAME}/mcmm_and_logic_opto_timing_effort
open_block ${DESIGN_NAME}/mcmm_and_logic_opto_timing_effort
...
# Collect the reports
set report_prefix "logic_opto_timing"
