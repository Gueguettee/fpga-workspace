...
report_area > reports/area_final_opto_report_p3.log
report_timing -significant_digits 10 > reports/timing_final_opto_report_p3.log

report_resources > reports/resource_final_opto_report_p3.log
report_utilization > reports/utilization_final_opto_report_p3.log

save_block -as ${DESIGN_NAME}/project3_final_opto
