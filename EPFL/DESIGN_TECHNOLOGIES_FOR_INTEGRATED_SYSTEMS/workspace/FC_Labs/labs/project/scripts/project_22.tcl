...
save_block -as ${DESIGN_NAME}/project22_read_rtl
...
report_area > reports/area_final_opto_report_p22.log
report_timing -significant_digits 10 > reports/timing_final_opto_report_p22.log

report_resources > reports/resource_final_opto_report_p22.log
report_utilization > reports/utilization_final_opto_report_p22.log

save_block -as ${DESIGN_NAME}/project22_final_opto
