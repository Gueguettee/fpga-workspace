...
#
# RadioAstro_HW_Vivado.tcl: Tcl script for re-creating project 'RadioAstro_HW_Vivado'
#
# Generated by Vivado on Thu May 15 23:16:45 +0200 2025
...
#
# 1. This project restoration tcl script (RadioAstro_HW_Vivado.tcl) that was generated.
#
...
#
#    "C:/git/galactic-speed-project/Project_Files/constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../Project_Files/constraints.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../Users/gaeta/AppData/Roaming/Xilinx/Project_Files/IP-catalog"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "RadioAstro_HW_Vivado"
...
set script_file "RadioAstro_HW_Vivado.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../Project_Files/RadioAstro_HW_Vivado"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../Users/gaeta/AppData/Roaming/Xilinx/Vivado/2022.2/xhub/board_store/xilinx_board_store"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../Project_Files/IP-catalog"]" $obj
...
set file "[file normalize "$origin_dir/../../Project_Files/constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../Project_Files/constraints.xdc"
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: fft_hw_0, and set properties
  set fft_hw_0 [ create_bd_cell -type ip -vlnv EPFL:hls:fft_hw:1.0 fft_hw_0 ]
  set_property CONFIG.C_M_AXI_GMEM_CACHE_VALUE {"1111"} $fft_hw_0
...
\
  ...
  connect_bd_intf_net -intf_net fft_hw_0_m_axi_gmem [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins fft_hw_0/m_axi_gmem]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins fft_hw_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins fft_hw_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins fft_hw_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces fft_hw_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] -force
  assign_bd_address -offset 0xFC000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces fft_hw_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fft_hw_0/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0xE0000000 -range 0x00400000 -target_address_space [get_bd_addr_spaces fft_hw_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP]
  exclude_bd_addr_seg -offset 0x40000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces fft_hw_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0]
  exclude_bd_addr_seg -offset 0x80000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces fft_hw_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP1]

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.619231",
   "Default View_TopLeft":"-179,-570",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port Vp_Vn_0 -pg 1 -lvl 0 -x 0 -y 100 -defaultsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1880 -y -30 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1880 -y 0 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 3 -x 1100 -y 40 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -x 650 -y 30 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 3 -x 1100 -y 370 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 4 -x 1460 -y -180 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -x 1460 -y -450 -defaultsOSRD
preplace inst fft_hw_0 -pg 1 -lvl 1 -x 230 -y -380 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 30 0 410 160 860 -70 1280
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 1 840 90n
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 4 40 170 N 170 900 200 1300
preplace netloc Vp_Vn_0_1 1 0 3 NJ 100 400 150 880
preplace netloc fft_hw_0_m_axi_gmem 1 1 3 NJ -390 NJ -390 1270
preplace netloc processing_system7_0_DDR 1 2 4 890J 150 NJ 150 1630 -30 N
preplace netloc processing_system7_0_FIXED_IO 1 2 4 870J 160 NJ 160 1640 0 N
preplace netloc processing_system7_0_M_AXI_GP0 1 2 2 840J -280 1290
preplace netloc processing_system7_0_M_AXI_GP1 1 2 2 850 -270 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 5 20 190 NJ 190 NJ 190 NJ 190 1610
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 3 910 170 NJ 170 1600
preplace netloc axi_mem_intercon_M00_AXI 1 1 4 420 180 NJ 180 NJ 180 1620
levelinfo -pg 1 0 230 650 1100 1460 1760 1880
pagesize -pg 1 -db -bbox -sgen -110 -570 1990 480
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../Project_Files/RadioAstro_HW_Vivado/RadioAstro_HW_Vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/RadioAstro_HW_Vivado.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/RadioAstro_HW_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/RadioAstro_HW_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
