...
void save_metrics(const std::string& filename, int config_id, configurations_t config, TTimes times, float snr, float freq_res, float velocity_res) {
    std::ofstream file;
    ...
    if (!file_exists) {
        ...
        const std::string header = 
            ...
            "Time Peak Detection,Time Velocity,Time Total,SNR,Freq Res,Vel Res,Timestamp\n";
        file << header;
    }
