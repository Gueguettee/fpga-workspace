...
inline void FXP_Mult_complex(FXP_TYPE ar, FXP_TYPE ai, FXP_TYPE br, FXP_TYPE bi, FXP_TYPE* res_r, FXP_TYPE* res_i) {
    *res_r = FXP_Mult(ar, br) - FXP_Mult(ai, bi);
    *res_i = FXP_Mult(ar, bi) + FXP_Mult(ai, br);
}
