...
//#pragma HLS INTERFACE m_axi depth=MAX_CHANNELS port=biases offset=slave
  ...
  #pragma HLS array_partition variable=tempFilters type=cyclic factor=3 dim=2
  #pragma HLS array_partition variable=tempFilters type=cyclic factor=3 dim=3
        ...
        #pragma HLS LOOP_TRIPCOUNT min=MAX_CHANNELS max=MAX_CHANNELS
          ...
          #pragma HLS unroll factor=3
            ...
            #pragma HLS LOOP_TRIPCOUNT min=3 max=3
              ...
              v = tempInput[iiCy][iChannel*inputWidth + x+cx];
