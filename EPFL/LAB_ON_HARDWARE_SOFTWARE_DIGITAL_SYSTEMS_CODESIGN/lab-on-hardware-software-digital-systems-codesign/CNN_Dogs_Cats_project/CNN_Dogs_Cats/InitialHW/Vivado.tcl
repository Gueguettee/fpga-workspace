...
#
# Generated by Vivado on Wed Mar 26 18:00:58 +0100 2025
...
#
#    "c:/git/lab-on-hardware-software-digital-systems-codesign/CNN_Dogs_Cats_project/Conv2D/Vivado/Vivado.srcs/sources_1/ip/Conv2D_HW_0/Conv2D_HW_0.xci"
#    "C:/git/lab-on-hardware-software-digital-systems-codesign/CNN_Dogs_Cats_project/Conv2D/Vivado/Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../Conv2D/Vivado/Vivado.srcs/sources_1/ip/Conv2D_HW_0/Conv2D_HW_0.xci"]"\
 "[file normalize "$origin_dir/../../Conv2D/Vivado/Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../Users/gaeta/AppData/Roaming/Xilinx/Conv2D/IP-catalog"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/../../Conv2D/Vivado"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../Conv2D/IP-catalog"]" $obj
...
set file "Conv2D_HW_0/Conv2D_HW_0.xci"
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.974376",
   "Default View_TopLeft":"110,-451",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1870 -y 20 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1870 -y 50 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 560 -y 160 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 1690 -y -70 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -x 1350 -y 220 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -x 1690 -y -310 -defaultsOSRD
preplace inst Conv2D_HW_0 -pg 1 -lvl 1 -x 560 -y -270 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -20 50 770 90 1530
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 780 200n
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 3 -10 -350 N -350 1520
preplace netloc axi_mem_intercon_M00_AXI 1 0 4 -30 -440 NJ -440 NJ -440 1840
preplace netloc processing_system7_0_DDR 1 1 3 NJ 110 N 110 1830
preplace netloc processing_system7_0_FIXED_IO 1 1 3 790J 100 N 100 1840
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 780J 80 1540
preplace netloc Conv2D_HW_0_m_axi_gmem 1 1 2 770J -370 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 4 -20 -430 NJ -430 NJ -430 1830
levelinfo -pg 1 -50 560 1350 1690 1870
pagesize -pg 1 -db -bbox -sgen -50 -470 1980 630
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../Conv2D/Vivado/Vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
...
# Create 'gadget_1' gadget (if not found)
if {[string equal [get_dashboard_gadgets  [ list "gadget_1" ] ] ""]} {
create_dashboard_gadget -name {gadget_1} -type utilization
}
set obj [get_dashboard_gadgets [ list "gadget_1" ] ]
set_property -name "active_reports" -value "" -objects $obj
set_property -name "active_reports_invalid" -value "" -objects $obj
set_property -name "active_run" -value "0" -objects $obj
set_property -name "hide_unused_data" -value "1" -objects $obj
...
set_property -name "run.step" -value "all_stages" -objects $obj
set_property -name "run.type" -value "implementation" -objects $obj
...
move_dashboard_gadget -name {gadget_1} -row 3 -col 0
