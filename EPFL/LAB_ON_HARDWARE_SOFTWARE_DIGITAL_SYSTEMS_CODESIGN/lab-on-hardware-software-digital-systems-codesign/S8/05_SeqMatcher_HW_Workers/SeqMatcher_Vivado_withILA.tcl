...
#
# SeqMatcher_HW_Vivado.tcl: Tcl script for re-creating project 'SeqMatcher_HW_Vivado'
#
# Generated by Vivado on Mon Apr 29 00:21:04 CEST 2024
...
#
# 1. This project restoration tcl script (SeqMatcher_HW_Vivado.tcl) that was generated.
#
...
set _xil_proj_name_ "SeqMatcher_HW_Vivado"
...
set script_file "SeqMatcher_Vivado.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/SeqMatcher_HW_Vivado"]"
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: SeqMatcher_HW_0, and set properties
  set SeqMatcher_HW_0 [ create_bd_cell -type ip -vlnv EPFL:hls:SeqMatcher_HW:1.0 SeqMatcher_HW_0 ]
...
\
  ...
  set_property CONFIG.C_DATA_DEPTH {4096} $system_ila_0


  # Create interface connections
  connect_bd_intf_net -intf_net SeqMatcher_HW_0_m_axi_masterPort [get_bd_intf_pins SeqMatcher_HW_0/m_axi_masterPort] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_mem_intercon_M00_AXI] [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins SeqMatcher_HW_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins SeqMatcher_HW_0/ap_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins SeqMatcher_HW_0/ap_rst_n] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces SeqMatcher_HW_0/Data_m_axi_masterPort] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SeqMatcher_HW_0/s_axi_control/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-554,-471",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1900 -y 60 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1900 -y 80 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -x 1640 -y 110 -defaultsOSRD
...
preplace inst SeqMatcher_HW_0 -pg 1 -lvl 3 -x 910 -y 400 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -x 1260 -y 450 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 5 -x 1640 -y 550 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 30 250 390 250 720 480 1110 220 1420 220 1860
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 240 NJ 240 NJ 240 NJ 240 NJ 240 1870
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 400 260 710 490 1100 570 NJ
preplace netloc processing_system7_0_DDR 1 5 1 NJ 60
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ 80
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 410 230 NJ 230 NJ 230 NJ 230 1880
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N 380
preplace netloc SeqMatcher_HW_0_m_axi_masterPort 1 3 1 N 390
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1410 100n
levelinfo -pg 1 0 210 560 910 1260 1640 1900
pagesize -pg 1 -db -bbox -sgen 0 0 2020 630
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/SeqMatcher_HW_Vivado/SeqMatcher_HW_Vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/SeqMatcher_HW_Vivado.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/SeqMatcher_HW_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/SeqMatcher_HW_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
