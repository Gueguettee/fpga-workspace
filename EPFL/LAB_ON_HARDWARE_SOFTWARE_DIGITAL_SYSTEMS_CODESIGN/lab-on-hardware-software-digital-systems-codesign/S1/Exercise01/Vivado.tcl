...
#
# Generated by Vivado on Sat Feb 22 12:48:40 +0100 2025
...
#
#    "C:/git/lab-on-hardware-software-digital-systems-codesign/Exercise01/HDL/buttons2leds.vhdl"
#    "C:/git/lab-on-hardware-software-digital-systems-codesign/Exercise01/HDL/pynqz2.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/HDL/buttons2leds.vhdl"]"\
 "[file normalize "$origin_dir/HDL/pynqz2.xdc"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/HDL/buttons2leds.vhdl"
...
set file "[file normalize "$origin_dir/HDL/pynqz2.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/HDL/pynqz2.xdc"
set file [file normalize $file]
...
if { [get_files buttons2leds.vhdl] == "" } {
  import_files -quiet -fileset sources_1 C:/git/lab-on-hardware-software-digital-systems-codesign/Exercise01/HDL/buttons2leds.vhdl
}
...
# Buttons2Leds
  ...
  connect_bd_net -net Buttons2Leds_0_leds [get_bd_ports leds] [get_bd_pins Buttons2Leds_0/leds]
  connect_bd_net -net btns_0_1 [get_bd_ports btns] [get_bd_pins Buttons2Leds_0/btns]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-450,-314",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace portBus leds -pg 1 -lvl 2 -x 250 -y -60 -defaultsOSRD
preplace portBus btns -pg 1 -lvl 0 -x -30 -y -60 -defaultsOSRD
preplace inst Buttons2Leds_0 -pg 1 -lvl 1 -x 110 -y -60 -defaultsOSRD
preplace netloc Buttons2Leds_0_leds 1 1 1 N -60
preplace netloc btns_0_1 1 0 1 N -60
levelinfo -pg 1 -30 110 250
pagesize -pg 1 -db -bbox -sgen -140 -120 360 120
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/Vivado/Vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
